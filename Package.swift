...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CarSwaddleNetworkRequest", url: "https://github.com/Car-Swaddle/CarSwaddleNetworkRequest", .upToNextMajor(from: "4.0.0")),
    ...
    targets: [
        ...
        .target(
            name: "CarSwaddleData",
            dependencies: ["CarSwaddleNetworkRequest", "Authentication", "Disk", "CarSwaddleStore"]),
        .testTarget(
